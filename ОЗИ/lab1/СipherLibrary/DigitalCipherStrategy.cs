...
namespace СipherLibrary
{
    public class DigitalCipherStrategy : CipherStrategy
    {
        ...
        public DigitalCipherStrategy()
        {
            ...
            for (int i = 40; i < 100; i++) // Добавляю в словарь символы и их числовое представление
            {
            ...
            for(int i = 10; i < 40; i++)
            {
                tokens.Add((char)(i + 90), i);
                inversedTokens.Add(i, (char)(i + 90));
            }
        }
        ...
        public string Decrypt(string textToDecrypt)
        {
            ...
            for(int i = 0; i < textToDecrypt.Length; i += 2)
            {
                ...
                try
                {
                    int num = Convert.ToInt32(textToDecrypt.Substring(i, 2));
